...
@Autonomous(name = "BloodCrackerbarrelVoid (Blocks to Java)", group = "BB")
public class BloodCrackerbarrelVoid extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (tgeLocation == 3) {
                ...
                TurnRobot(88, 0.18);
                sleep(3000);
                MoveRobot(186, MainSpeed);
                StrafeRobot(76, MainSpeed);
                Place_On_Board(6.5, 4.5);
                // strafe right and park
                MoveRobot(5, MainSpeed);
                StrafeRobot(-86, MainSpeed);
                MoveRobot(75, MainSpeed);
                ...
                TurnRobot(88, MainSpeed);
                sleep(3000);
                // forward to board and left
                MoveRobot(200, MainSpeed);
                StrafeRobot(56, MainSpeed);
                Place_On_Board(19, 4.5);
                // strafe right and park
                StrafeRobot(-60, MainSpeed);
                MoveRobot(90, MainSpeed);
            } else {
                // location 1
                // right
                StrafeRobot(-30, MainSpeed);
                ...
                TurnRobot(88, 0.18);
                sleep(3000);
                MoveRobot(232, MainSpeed);
                StrafeRobot(38, MainSpeed);
                Place_On_Board(12, 4.5);
