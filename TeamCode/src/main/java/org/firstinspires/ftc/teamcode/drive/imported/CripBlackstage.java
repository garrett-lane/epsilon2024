...
@Autonomous(name = "CripBlackstage (Blocks to Java)", group = "AA")
public class CripBlackstage extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (tgeLocation == 1) {
                ...
                // left turn
                TurnRobot(-97, MainSpeed);
                // strafe left to 1st postition
                StrafeRobot(-6, MainSpeed);
                MoveRobot(-14, MainSpeed);
                Place_On_Board(27, 3.7);
                sleep(500);
                // strafe righ 1
                StrafeRobot(-48, MainSpeed);
                // forward 1
                ...
                // RELEASE PIXEL LEFT (PURPLE)
                MoveRobot(-15, MainSpeed);
                // turn left 90
                TurnRobot(-90, MainSpeed);
                // Strafe to 2nd position
                StrafeRobot(9.5, MainSpeed);
                MoveRobot(14, MainSpeed);
                Place_On_Board(44, 3.75);
                sleep(500);
                // strafe righ 1
                StrafeRobot(-68, MainSpeed);
                // forward 1
                ...
                MoveRobot(20, MainSpeed);
                Place_On_Board(23, 3.75);
                sleep(500);
                StrafeRobot(-85, MainSpeed);
                MoveRobot(65, MainSpeed);
                sleep(1000);
            }
            sleep(30000);
     ...
     * Describe this function...
     */
    private void StrafeRobot(double dist, double speed) {
        ResetEncoder();
        // Wheel Directions
        fl.setDirection(DcMotor.Direction.REVERSE);
