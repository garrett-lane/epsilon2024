...
@Autonomous(name = "CripCrackerbarrelVoid (Blocks to Java)", group = "BB")
public class CripCrackerbarrelVoid extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            } else if (201 < tgeLocation && tgeLocation < 474) {
                tgeLocation = 2;
            ...
            if (tgeLocation == 1) {
                ...
                TurnRobot(-91.5, 0.18);
                sleep(3000);
                MoveRobot(185, MainSpeed);
                StrafeRobot(-90, MainSpeed);
                Place_On_Board(8, 4.5);
                // strafe right and park
                MoveRobot(5, MainSpeed);
                StrafeRobot(82, MainSpeed);
                MoveRobot(70, MainSpeed);
                ...
                sleep(3000);
                // forward to board and left
                MoveRobot(200, MainSpeed);
                StrafeRobot(-64, MainSpeed);
                Place_On_Board(10, 4.5);
                // strafe right and park
                StrafeRobot(58, MainSpeed);
                ...
                TurnRobot(-90, 0.18);
                sleep(3000);
                MoveRobot(224, MainSpeed);
                StrafeRobot(-47, MainSpeed);
                Place_On_Board(11, 4.5);
                StrafeRobot(50, MainSpeed);
    ...
    private void Place_On_Board(int Distance_From_Board, double Slide_Hieght) {
        ...
        // reverse?
        sleep(1000);
        MoveRobot(-(Distance_From_Board + 3), MainSpeed);
        OperateClaw(0, 0);
        OperateClaw(1, 0);
        sleep(800);
        dump.setPosition(0.3);
     ...
     * Describe this function...
     */
    private void TurnRobot(double dist, double speed) {
        ResetEncoder();
        // Wheel Directions
        fl.setDirection(DcMotor.Direction.REVERSE);
        fr.setDirection(DcMotor.Direction.REVERSE);
        ...
        // Set target positions to dist
        fl.setTargetPosition((int) (dist * 8.36));
        fr.setTargetPosition((int) (dist * 8.36));
        bl.setTargetPosition((int) (dist * 8.36));
        br.setTargetPosition((int) (dist * 8.36));
        RunToPos();
        // set power to speed
        fl.setPower(speed);
        fr.setPower(speed);
